        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-blue-500">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">YouTube Account</h2>
                <p className="text-gray-600 mt-1">Connect your YouTube account to access your subscriptions</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="flex-1">
                    <p className="text-green-800 font-semibold">Connected to YouTube</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900">About Subscription Curator</h2>
                <p className="text-gray-600 mt-1">Organize and curate your YouTube subscriptions</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Channel Selection</h3>
                <p className="text-sm text-gray-600">Choose which channels to include in your digest</p>
              </div>
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">Organize channels into custom categories</p>
              </div>
              ...
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Video Digest</h3>
                <p className="text-sm text-gray-600">Get curated videos from your selected channels</p>
              </div>
            </div>
          </div>
